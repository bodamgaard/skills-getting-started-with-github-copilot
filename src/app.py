...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and compete in tennis tournaments",
    ...
    "Drama Club": {
        ...
        "max_participants": 25,
        "participants": ["alexis@mergington.edu", "ava@mergington.edu", "noah@mergington.edu"]
    },
    "Visual Arts Studio": {
        "description": "Explore painting, sculpture, and other visual art techniques",
    ...
    "Science Club": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["ryan@mergington.edu", "chloe@mergington.edu", "alexander@mergington.edu"]
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    def unregister_from_activity(activity_name: str, email: str):
        ...
        if email not in activity["participants"]:
            raise HTTPException(status_code=400, detail=f"Student not signed up for {activity_name}")
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail=f"Student already signed up for {activity_name}")
